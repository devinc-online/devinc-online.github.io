        ...
        <div class="container hz-panel">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 mt-5">
                    <div class="prg-title">CURRENT PROJECT PROGRESS
                        <hr>
                    </div>
                    <p class="mt-2"><a href="/gradebookdoc">Gradebook</a></p>
                    <div class="progress">
                                        ...
                                        <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo">
                                            <div class="card-block mt-4 mr-4 mb-4 ml-3">
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col">
                                                            You can manage Project Survey in a huge coverage area simultaneously because all roll out status could be synchronized and presented into MPColla server.
                                                        </div>
                                                        <div class="col">
